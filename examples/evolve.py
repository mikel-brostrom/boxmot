...
def parse_opt():
    ...
    parser.add_argument(
        "--tracking-method", type=str, default="deepocsort", help="strongsort, ocsort, bytetrack, deepocsort, botsort"
    )
    ...
    parser.add_argument(
        "--objectives", type=str, default="HOTA,MOTA,IDF1", help="set of objective metrics: HOTA,MOTA,IDF1"
    )
