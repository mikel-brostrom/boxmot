...
!!! example
    ...
    === "Python"
        ...
        model = Boxmot(detector="yolov8n", reid="lmbn_n_duke", tracker="ocsort")
        tuned = model.tune(benchmark="mot17-ablation", n_trials=10)
...
!!! example
    ...
    === "Python"
        ...
        model = Boxmot(detector="yolov8n", reid="lmbn_n_duke", tracker="bytetrack")
        tuned = model.tune(
