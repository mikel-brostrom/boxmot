...
from module.ultralytics.utils import LOGGER, checks, clean_url, emojis, is_online, url2file
...
def attempt_download_asset(file, repo='ultralytics/assets', release='v0.0.0'):
    ...
    from module.ultralytics.utils import SETTINGS  # scoped for circular import
