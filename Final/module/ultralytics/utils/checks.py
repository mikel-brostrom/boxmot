...
from module.ultralytics.utils import (AUTOINSTALL, LOGGER, ONLINE, ROOT, USER_CONFIG_DIR, ThreadingLocked, TryExcept,
                               clean_url, colorstr, emojis, is_colab, is_docker, is_jupyter, is_kaggle,
