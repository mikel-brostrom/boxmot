...
class ORBStrategy(CMCInterface):
    ...
    def apply(self, curr_img, prev_img, detections):

        curr_img, prev_img = self.preprocess(curr_img, curr_img)
...
def main():
    ...
    warp_matrix, matches_img = orb.apply(prev_img, prev_img, prev_dets)
    start = time.process_time()
    warp_matrix, matches_img = orb.apply(curr_img, curr_img, curr_dets)
