...
@click.pass_context
def eval(ctx, data, detector, reid, classes, split, detection_source, tune_kf, compare_trackeval, **kwargs):
...
def train_options(func):
    ...
    options = [
        ...
        click.option('--pyramid-resize-mode',
                     type=click.Choice(['bilinear', 'pool_nearest'], case_sensitive=False),
                     default=TRAIN_DEFAULTS.pyramid_resize_mode, show_default=True,
                     help='Pyramid resizing: legacy bilinear or average-pool down/nearest up'),
        ...
        click.option('--head-type',
                     ...
                     help='CSL-TinyViT branch head, including optional Stage-2 G/P/C specialists'),
