...
def main(args) -> dict:
    ...
    preprocess = getattr(args, "preprocess", None) or checkpoint.get("preprocess", "resize")
    ...
    model = MODEL_FACTORY[model_name](
        num_classes=num_classes, loss="softmax", pretrained=False, use_gpu=device.type != "cpu",
    )
    ...
    if output_dir:
        ...
        json_path = out_path / f"eval_{model_name}_{dataset_name}.json"
    else:
