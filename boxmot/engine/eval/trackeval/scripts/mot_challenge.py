...
repo_root = next(
    (
        ...
        if (parent / "pyproject.toml").exists() and (parent / "boxmot").is_dir()
    ),
    None,
)
...
from boxmot.utils import TRACKEVAL  # noqa: E402

trackeval_dir = TRACKEVAL / "trackeval"
sys.path.insert(0, str(trackeval_dir))

import trackeval  # noqa: E402

from boxmot.engine.eval.trackeval.datasets import CustomMotChallenge2DBox  # noqa: E402
