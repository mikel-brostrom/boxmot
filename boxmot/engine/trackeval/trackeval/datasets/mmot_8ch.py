...
from mmot.mmlab.hs_mmrotate import poly2obb

import torch


class mmot_8ch(_BaseDataset):
    """Dataset class for mmot-8ch tracking"""
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            'GT_FOLDER': '/data/users/litianhao/data/mmot/test/mot',  # Location of GT data
            'IMG_FOLDER': '/data/users/litianhao/data/mmot/test/npy',  #图像目录
            'TRACKERS_FOLDER': '/data3/litianhao/mmot',  # Trackers location
    ...
    def _load_raw_file(self, tracker, seq, is_gt):
        """Load a file (gt or tracker) in the mmot_RGB format
