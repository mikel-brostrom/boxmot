...
_SENSOR_ROLES = frozenset({"detections_2d", "detections_3d", "calibration", "poses"})
_DIRECTORY_FORMATS = frozenset({"image-directory", "instance-png", "kitti-detections", "kitti-object-labels"})
