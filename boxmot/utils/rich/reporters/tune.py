...
from boxmot.utils.rich.workflow.reporting import RichWorkflowCallback, RichWorkflowReporter, SilentProgressReporter

TUNE_SETUP_STEP = step_labels.SETUP
TUNE_GENERATE_STEP = step_labels.GENERATE
...
class TuneWorkflowReporter(RichWorkflowReporter):
    ...
    def __init__(self, args: Any, *, maximize: list[str], minimize: list[str]) -> None:
        ...
        self.steps = step_labels.tune_steps(tune_kf=bool(getattr(args, "tune_kf", False)))
