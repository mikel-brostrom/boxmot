...
from boxmot.utils.analysis import gepa_results as analysis_module
...
def test_build_gepa_report_extracts_metrics_and_headlines(tmp_path):
    ...
    assert report.accepted_transitions[0].headline == "Added lifecycle-aware association priors and delayed confirmation"
