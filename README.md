...
$ boxmot eval --yolo-model yolov8n.pt --reid-model osnet_x0_25_msmt17.pt --tracking-method ocsort     --verbose --source ./boxmot/engine/trackeval/data/MOT17-ablation/train
```
